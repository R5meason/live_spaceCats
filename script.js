...
var blinkDuration = setInterval(blinker, 1000);
...
function display_remaining_time() {
    var timeRemaining = max_turn_time - current_turn_time;
    $("#remaining_time").text(max_turn_time - current_turn_time);
    $("#countdown").text("Hurry! End of turn in: ");
...
function toggle_player() {
    ...
    if (its_player_ones_turn && !endOfGame) {
